...
EXECUTABLE = ./plram_access_versal
...
$(BUILD_DIR)/mmult.xclbin: $(TEMP_DIR)/mmult.xo
	mkdir -p $(BUILD_DIR)
	v++ $(VPP_FLAGS) -l $(VPP_LDFLAGS) --temp_dir $(TEMP_DIR) $(VPP_LDFLAGS_mmult) -o'$(LINK_OUTPUT)' $(+) --hls.pre_tcl hls_config.tcl
	v++ -p $(LINK_OUTPUT) $(VPP_FLAGS) --package.out_dir $(PACKAGE_OUT) -o $(BUILD_DIR)/mmult.xclbin --hls.pre_tcl hls_config.tcl
